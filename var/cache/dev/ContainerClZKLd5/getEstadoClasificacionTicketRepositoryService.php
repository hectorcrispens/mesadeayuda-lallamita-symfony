...
// Returns the private 'App\Repository\EstadoClasificacionTicketRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EstadoClasificacionTicketRepository.php';

return $this->privates['App\Repository\EstadoClasificacionTicketRepository'] = new \App\Repository\EstadoClasificacionTicketRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

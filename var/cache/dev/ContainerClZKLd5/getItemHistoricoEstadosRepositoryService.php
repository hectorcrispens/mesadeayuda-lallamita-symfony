...
// Returns the private 'App\Repository\ItemHistoricoEstadosRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ItemHistoricoEstadosRepository.php';

return $this->privates['App\Repository\ItemHistoricoEstadosRepository'] = new \App\Repository\ItemHistoricoEstadosRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

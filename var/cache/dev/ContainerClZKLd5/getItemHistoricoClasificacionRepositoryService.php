...
// Returns the private 'App\Repository\ItemHistoricoClasificacionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ItemHistoricoClasificacionRepository.php';

return $this->privates['App\Repository\ItemHistoricoClasificacionRepository'] = new \App\Repository\ItemHistoricoClasificacionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

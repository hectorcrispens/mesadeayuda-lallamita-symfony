...
// Returns the private 'App\Repository\DireccionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DireccionRepository.php';

return $this->privates['App\Repository\DireccionRepository'] = new \App\Repository\DireccionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

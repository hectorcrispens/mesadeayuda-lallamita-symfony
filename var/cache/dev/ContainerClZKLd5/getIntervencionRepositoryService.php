...
// Returns the private 'App\Repository\IntervencionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/IntervencionRepository.php';

return $this->privates['App\Repository\IntervencionRepository'] = new \App\Repository\IntervencionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

...
// Returns the private 'App\Repository\ItemHistoricoIntervencionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ItemHistoricoIntervencionRepository.php';

return $this->privates['App\Repository\ItemHistoricoIntervencionRepository'] = new \App\Repository\ItemHistoricoIntervencionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

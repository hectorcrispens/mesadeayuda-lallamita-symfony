...
// Returns the private 'App\Repository\EstadoGrupoResolucionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EstadoGrupoResolucionRepository.php';

return $this->privates['App\Repository\EstadoGrupoResolucionRepository'] = new \App\Repository\EstadoGrupoResolucionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

...
// Returns the private 'App\Repository\ClasificacionTicketRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ClasificacionTicketRepository.php';

return $this->privates['App\Repository\ClasificacionTicketRepository'] = new \App\Repository\ClasificacionTicketRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

...
// Returns the private 'App\Repository\GrupoResolucionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/GrupoResolucionRepository.php';

return $this->privates['App\Repository\GrupoResolucionRepository'] = new \App\Repository\GrupoResolucionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

...
// Returns the private 'App\Repository\EstadoIntervencionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EstadoIntervencionRepository.php';

return $this->privates['App\Repository\EstadoIntervencionRepository'] = new \App\Repository\EstadoIntervencionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

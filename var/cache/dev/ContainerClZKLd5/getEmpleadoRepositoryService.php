...
// Returns the private 'App\Repository\EmpleadoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EmpleadoRepository.php';

return $this->privates['App\Repository\EmpleadoRepository'] = new \App\Repository\EmpleadoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

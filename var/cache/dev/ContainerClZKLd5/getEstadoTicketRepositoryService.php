...
// Returns the private 'App\Repository\EstadoTicketRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EstadoTicketRepository.php';

return $this->privates['App\Repository\EstadoTicketRepository'] = new \App\Repository\EstadoTicketRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
